...
<div class="untree_co-hero overlay" style="background-image: url('{{ asset('learner') }}/images/hero-img-1-min.jpg');">
...
<div class="untree_co-section">
      ...
      <div class="row">
        <div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div class="custom-media">
            <a href="#"><img src="{{ asset('learner') }}/images/img-school-1-min.jpg" alt="Image" class="img-fluid"></a>
        ...
        <div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div class="custom-media">
            <a href="#"><img src="{{ asset('learner') }}/images/img-school-2-min.jpg" alt="Image" class="img-fluid"></a>
            <div class="custom-media-body">
              <div class="d-flex justify-content-between pb-3">
                <div class="text-primary"><span class="uil uil-book-open"></span> <span>43 lesson</span></div>
                <div class="review"><span class="icon-star"></span> <span>4.8</span></div>
        ...
        <div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div class="custom-media">
            <a href="#"><img src="{{ asset('learner') }}/images/img-school-3-min.jpg" alt="Image" class="img-fluid"></a>
            <div class="custom-media-body">
              <div class="d-flex justify-content-between pb-3">
                <div class="text-primary"><span class="uil uil-book-open"></span> <span>43 lesson</span></div>
                <div class="review"><span class="icon-star"></span> <span>4.8</span></div>
  ...
  <div class="untree_co-section pt-0 bg-img overlay" style="background-image: url('{{ asset('learner') }}/images/img-school-1-min.jpg');">
    <div class="container">
      ...
      <div class="row justify-content-between">
        ...
        <div class="col-lg-6" data-aos="fade-up" data-aos-delay="400">
          ...
          <a href="https://vimeo.com/342333493" data-fancybox class="video-wrap">
            ...
            <img src="{{ asset('learner') }}/images/img-school-4-min.jpg" alt="Image" class="img-fluid rounded">
          </a>
        </div>
      </div>
    </div>
          ...
          <div class="owl-carousel wide-slider-testimonial">
            <div class="item">
              <blockquote class="block-testimonial">
                ...
                <div class="author">
                  <img src="{{ asset('learner') }}/images/person_1.jpg" alt="Free template by TemplateUX">
                  <h3>John Doe</h3>
            ...
            <div class="item">
              <blockquote class="block-testimonial">
                ...
                <div class="author">
                  <img src="{{ asset('learner') }}/images/person_2.jpg" alt="Free template by TemplateUX">
            ...
            <div class="item">
              <blockquote class="block-testimonial">
                ...
                <div class="author">
                  <img src="{{ asset('learner') }}/images/person_3.jpg" alt="Free template by TemplateUX">
                  <h3>Rob Smith</h3>
